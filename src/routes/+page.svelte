	...
	let features = [
		{
			...
			description:
				"Experience the speed and efficiency of Solana's blockchain technology for real estate investment",
			icon: '⚡'
		},
		{
		...
		},
		{
			...
			description:
				'Automated rental distributions and ownership management through blockchain technology',
			icon: '📋'
		},
		{
